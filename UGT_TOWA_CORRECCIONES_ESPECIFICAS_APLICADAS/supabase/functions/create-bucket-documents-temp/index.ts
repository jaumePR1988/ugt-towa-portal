...
Deno.serve(async (req) => {
    ...
    bucketConfig.allowed_mime_types = ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "image/*"];
    ...
    const policyQueries = [
        ...
        `CREATE POLICY "Public Update for documents" ON storage.objects FOR UPDATE USING (bucket_id = 'documents');`,
        // Allow public to delete objects in this bucket
        `CREATE POLICY "Public Delete for documents" ON storage.objects FOR DELETE USING (bucket_id = 'documents');`
    ];
    ...
    return new Response(JSON.stringify({
        ...
        name: 'documents',
        public: true,
        allowed_mime_types: ["application/pdf", "application/msword", "application/vnd.openxmlformats-officedocument.wordprocessingml.document", "application/vnd.ms-excel", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", "image/*"],
