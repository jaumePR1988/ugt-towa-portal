Deno.serve(async (req) => {
  ...
  try {
    ...
    const fileName = `attachment_${timestamp}_${randomStr}.${extension}`;

    // Usar la API de storage directamente con datos existentes
    ...
    // Subir archivo usando el token del usuario autenticado
