...
export default function AffiliateDashboard() {
  const { user, profile, isAffiliate } = useAuth();
          ...
          <div className="md:col-span-3 space-y-6">
            ...
            <div className="bg-gradient-to-r from-red-600 to-red-700 text-white rounded-lg shadow-lg p-8">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className="text-3xl font-bold mb-2">Bienvenido/a, {profile?.full_name}</h1>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-lg font-semibold text-gray-900">
                    {profile?.created_at && format(new Date(profile.created_at), "d 'de' MMMM 'de' yyyy", { locale: es })}
                  </p>
                </div>
              </div>
            </div>
